...
exports._base16To36 = exports._base36To16 = exports.BigNumber = exports.isBigNumberish = exports._constructorGuard = void 0;
/**
 *  BigNumber
 *
...
class BigNumber {
    ...
    static from(value) {
        ...
        if (typeof (value) === "string") {
            if (value.match(/^-?0x[0-9a-f]+$/i)) {
                return new BigNumber(exports._constructorGuard, toHex(value));
            }
            if (value.match(/^-?[0-9]+$/)) {
                return new BigNumber(exports._constructorGuard, toHex(new BN(value)));
            }
    ...
    static constructorGuard() {
        return exports._constructorGuard;
    }
}
